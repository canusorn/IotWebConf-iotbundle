...
const char IOTWEBCONF_HTML_END[] PROGMEM          = "<script>var sysSpan = document.createElement('span');sysSpan.classList.add(\"tooltiptext\");sysSpan.classList.add(\"tooltip-right\");sysSpan.innerHTML = \"<b>ตั้งค่าเบื้องต้น</b><br><br>1.WIFI SSID-ใส่ชื่อไวไฟ<br><br>2.WIFI password-ใส่รหัสผ่านไวไฟ<br><br>3.อีเมล์ที่ได้สมัครที่เว็บ<br><br>4.รหัสผ่าน user\";var iwcsys = document.getElementById(\"iwcSys\");iwcsys.classList.add(\"tooltip\");iwcsys.appendChild(sysSpan);document.getElementById(\"iwcApPassword\").placeholder = \"ปล่อยว่างไว้ถ้าไม่ต้องการเปลี่ยน\";\nif(document.getElementById(\"iwcWifiSsid\").value == \"\"){\ndocument.getElementById(\"iwcWifiSsid\").placeholder = \"ใส่ชื่อไวไฟ\";\ndocument.getElementById(\"iwcWifiPassword\").placeholder = \"ใส่รหัสผ่านไวไฟ\";\n}else{\ndocument.getElementById(\"iwcWifiPassword\").placeholder = \"ปล่อยว่างไว้ถ้าไม่ต้องการเปลี่ยน\";\n}\nif(document.getElementById(\"emailParam\").value == \"\"){\ndocument.getElementById(\"emailParam\").placeholder = \"ใส่ email\";\ndocument.getElementById(\"passParam\").placeholder = \"ใส่รหัสผ่าน user\";\n}else{\ndocument.getElementById(\"passParam\").placeholder = \"ปล่อยว่างไว้ถ้าไม่ต้องการแก้ไข\";\n}</script></div></body></html>";
